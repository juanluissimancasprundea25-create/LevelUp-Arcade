...
/**
 * Datos de entrada para crear un nuevo proveedor.
 *
 * <p>{@code nombreEmpresa} y {@code cif} son obligatorios. Los datos de
 * contacto son opcionales y pueden completarse mas tarde.
 */
